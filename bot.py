...
CONSENT_TEXT = (
    "Небольшая формальность перед продолжением путешествия 😊\n\n"
    "Нам нужно сохранить немного информации о Вас — обещаем, без лишних вопросов и строго по делу.\n\n"
    "Нажимая «Согласен(а)», Вы разрешаете нам обработать Ваши персональные данные.\n"
    "Мы никому их не показываем и никуда не передаем — всё строго конфиденциально."
)
